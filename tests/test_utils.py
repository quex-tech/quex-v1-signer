...
from quex_backend.utils import ABIEncodingError, JQProcessingError, process_json


class TestUtils(unittest.TestCase):
    def test_process_json_multiple_values(self):
        # Input JSON as a dictionary
        input_json = {"value1": 123456, "value2": 654321}
    ...
    def test_process_json_with_plutus_encoder(self):
        input_json = {"enabled": True, "name": "oracle"}
